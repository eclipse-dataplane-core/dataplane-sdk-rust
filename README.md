![](./docs/logo/rust.sdk.logo.stacked.svg)

A Data Plane SDK for Rust. This SDK provides components for creating Rust-based data planes that interface with Dataspace
